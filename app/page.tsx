...
export default function Home() {
  ...
  return <main>
    <header className="site-header"><a href="#top" className="brand" aria-label="FirmVault home"><img src="/firmvault-logo.svg" alt="FirmVault"/></a><nav aria-label="Primary navigation"><a href="#how">How it works</a><a href="#trust">Why FirmVault</a><a href="#waitlist" className="nav-cta">Join waitlist</a></nav></header>
